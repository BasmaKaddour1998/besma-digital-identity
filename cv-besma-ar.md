...
### تطبيقات الويب والهاتف · الأنظمة البرمجية · برمجيات تحليل الأسواق المالية
...
مهندسة برمجيات تعمل في تصميم برامج وتطبيقات احترافية لتحليل الأسواق المالية، إلى جانب تطبيقات الويب والهاتف، والأنظمة الخلفية، ولوحات المعلومات، والمنصات الرقمية، وتطبيقات الذكاء الاصطناعي والأتمتة. تشمل الخبرة المتطلبات والمعمارية وتنفيذ واجهات المستخدم وتطوير الواجهات الأمامية والخلفية وتصميم قواعد البيانات وواجهات REST والمصادقة والتكاملات والاختبار وتصحيح الأخطاء والنشر والصيانة وتحسين الأداء.
...
## برمجيات وتطبيقات تحليل الأسواق المالية

تصميم برامج وتطبيقات احترافية لتحليل الأسواق المالية، ومعالجة البيانات وتصويرها وبناء لوحات المعلومات ومسارات البحث وإعداد التقارير.
