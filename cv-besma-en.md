...
### Databases
PostgreSQL, MySQL, MongoDB, Firebase, database architecture, data modeling, API/database integration, query optimization, and production data handling.

### Cloud, DevOps & Tools
Git, GitHub, npm, Gradle, Android Studio, Xcode, Vercel, Render, terminal-based development workflows, environment configuration, production deployments, API deployment, and frontend/backend integration.

### Platforms & Integrations
Telegram Mini Apps, WebView applications, native mobile integration, third-party APIs, authentication systems, real-time systems, and cloud services.
...
- WhatsApp and Email: available through the website contact section
